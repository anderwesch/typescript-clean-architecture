...
test("Should be parking log", async function() {
...
test.skip("Should be full", async function() {
    ...
    const parkingLotBeforeEnter = await getParkingLot.execute("shopping");
    expect(parkingLotBeforeEnter.occupiedSpaces).toBe(0);
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-03-01T13:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0002", new Date("2021-03-01T13:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0003", new Date("2021-03-01T13:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0004", new Date("2021-03-01T13:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0005", new Date("2021-03-01T13:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0006", new Date("2021-03-01T13:00:00"));
